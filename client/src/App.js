      ...
      <Container component="main" maxWidth="xs">
        ...
        <div className={classes.paper}>
          ...
          <form className={classes.form} noValidate>
            ...
            <FileSelector setSelectedFile={this.setSelectedFile} />
            {/* Controls fax number input. */}
            <FaxNumberInput setFaxNumber={this.setFaxNumber} />
            {/* Controls file upload and faxing. */}
            <FileFaxer selectedFile={this.state.selectedFile} faxNumber={this.state.faxNumber} />
          </form>
        </div>
        <Box mt={8}>
          <Copyright />
